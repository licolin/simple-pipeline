...
export default function Page() {
    ...
    useEffect(() => {
        ...
        async function fetchNodeInfo() {
            ...
            if (data?.data?.nodes) {
                const transformedData = JSON.parse(data.data.nodes).map((item: { data: { label: any; }; }) => ({
    ...
    return (
        ...
        <div className="flex w-full">
            <div className="mt-2 w-4/5 pr-2">
                <div className="mt-2 w-full h-32">
                    ...
                    <div className="flex justify-between mt-2 w-full">
                        <div className="border border-slate-300 shadow shadow-slate-400 rounded my-2 mx-1 py-1 px-2">
                ...
                <div className="mt-3 w-full">
                    ...
                    <div className="w-full mt-1">
                        {tab === 1 ? <div>
                            <span onClick={handleUpdate} className="mx-[1px] mb-[2px] my-1 px-2 py-1 text-xs border-none rounded-sm bg-fuchsia-400 hover:cursor-pointer text-white">
                                保存配置信息
                            </span>
            ...
            <div className="mt-2 w-1/5 ml-2 mr-2">
                ...
                <div className="w-full min-h-[568px] border border-slate-300 shadow shadow-slate-300 rounded font-sans">
                    {details.map((detail, index) => (
                            ...
                            >
              <span onClick={() => {setCurrentID(index);handleClick(detail)}}
