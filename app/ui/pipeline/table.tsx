          ...
          <table className="hidden min-w-full text-gray-900 md:table border-t border-gray-300">
            ...
            <tbody className="bg-white">
              {pipelines?.map((invoice) => (
                  <tr
                      key={invoice.name}
                      className="w-full border-b py-2 text-sm last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-sm [&:first-child>td:last-child]:rounded-tr-sm [&:last-child>td:first-child]:rounded-bl-sm [&:last-child>td:last-child]:rounded-br-sm"
                  >
